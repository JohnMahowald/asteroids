...
(function () {
  ...
  Ship.prototype.draw = function(ctx) {
    ...
    var right_x = this.pos[0] + this.radius * Math.cos(2 * Math.PI / 3 + this.direction)
    var right_y = this.pos[1] + this.radius * Math.sin(2 * Math.PI / 3 + this.direction)
    
    var left_x = this.pos[0] + this.radius * Math.cos(4 * Math.PI / 3 + this.direction)
    var left_y = this.pos[1] + this.radius * Math.sin(4 * Math.PI / 3 + this.direction)
